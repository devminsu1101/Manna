...
| 공동체 (목록·대문·생성) | 🟡 **화면 완료(목데이터)** / 쓰기 API 대기 |
| 기도 (중보기도실·상세·기도제목 작성/이력) | 🟡 **화면 완료(목데이터)** / 쓰기 API 대기 |
...
> 위 🟡 셋의 막힌 버튼을 묶고 있던 CSRF 재활성(D-404)은 **2026-09-25에 끝났다**(D-3101).
> 이제 남은 건 각 쓰기 API 자체다 — 첫 번째가 `POST /communities`.
