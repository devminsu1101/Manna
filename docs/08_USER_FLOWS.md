...
- 카카오 — ~~MVP 필수로 승격(D-1702)~~ → **MVP에서 보류**(D-2701). 카톡 인앱 브라우저가
  Google 로그인을 정말 막는지 실사용으로 먼저 확인한다. 그때까지 버튼은 "(준비 중)"
...
| `Login Page.png` | `/login` | 일부 | Kakao·Naver는 "(준비 중)". 카카오는 MVP에서 보류 — 인앱 차단 실사용 확인 후 결정(D-2701) |
