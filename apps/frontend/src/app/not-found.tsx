 ...
 *
 * 실제로 도달하는 경로는 둘이다.
 *  1. 없는 자원 — 없는 권(`/bible/zz/1`)·범위 밖 장(`/bible/gn/99`), 그리고 **승인 전인
 *     공동체**(`/communities/{id}`). 후자는 403이 아니라 404여야 한다 — 403은 "그 방이
 *     있긴 하다"를 알려 주는데, 승인 전에는 방의 존재 자체를 숨기는 것이 D-1707의 취지다
 *  2. 아직 만들지 않은 라우트 — 하단 네비의 `/prayer`·`/sharings/new`
